    ...
    <div class="panel panel-default ">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="../../FrontController.php?class=QuestaoController">
                ...
                <input type="hidden" name="tipo" value="trueFalse"/>
                ...
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="titulo">a) <select name="gabaritoVF1"><option value="v">V</option><option value="f">F</option></select></label>
                    <div class="col-sm-7">
                        <textarea class="form-control" name="alt1" id="nome" placeholder="Digite a questao" value=""></textarea>
                    </div>
                </div>

                <div class="form-group ">
                    <label class="control-label col-sm-2" for="titulo">b) <select name="gabaritoVF2"><option value="v">V</option><option value="f">F</option></select></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="titulo">c) <select name="gabaritoVF3"><option value="v">V</option><option value="f">F</option></select></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="titulo">d) <select name="gabaritoVF4"><option value="v">V</option><option value="f">F</option></select></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="titulo">e) <select name="gabaritoVF5"><option value="v">V</option><option value="f">F</option></select></label>
                    <div class="col-sm-7">
