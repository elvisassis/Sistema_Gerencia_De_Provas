...
<div class="panel-group ">
    <div class="panel panel-default ">
        <div class="panel-heading" >
            <h3 class="panel-title">Listagem de disciplinas</h3>
        </div>
        <p></p>
        <p></p>
            ...
            <div class="panel panel-default">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="CadastroDisciplina.php" label= "Cadastrar" ><span title="Adicionar" class="glyphicon glyphicon-plus" aria-hidden="true"/></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
